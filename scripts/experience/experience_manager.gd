...
func add_experience(amount, source = "default"):
	...
	# 调试输出经验值
	print("ExperienceManager: 经验值更新前 = ", current_experience - modified_amount, ", 增加经验 = ", modified_amount, ", 更新后 = ", current_experience, ", 升级所需 = ", experience_to_level)
...
func reset():
	...
	# 调试输出
	print("ExperienceManager: 重置经验系统 - 当前经验 = ", current_experience, ", 当前等级 = ", current_level, ", 升级所需 = ", experience_to_level)
